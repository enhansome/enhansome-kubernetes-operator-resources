...
* [Kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,313 | 🐛 64 | 🌐 Go | 📅 2026-09-11 - The SDK for building Kubernetes APIs using CRDs.
...
* [KubeOps](https://github.com/buehler/dotnet-operator-sdk) ⭐ 371 | 🐛 4 | 🌐 C# | 📅 2026-09-12 - KubeOps is a kubernetes operator sdk in dotnet. Strongly inspired by kubebuilder.
...
* [KubeStellar](https://github.com/kubestellar/kubestellar) ⭐ 712 | 🐛 214 | 🌐 Go | 📅 2026-09-03 - Multi-cluster configuration management for edge, multi-cloud, and hybrid scenarios using Kubernetes.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 134 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-13 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations.

## Dashboards & UIs

* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 134 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-13 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations across edge and cloud clusters.
