...
* [Kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,310 | 🐛 63 | 🌐 Go | 📅 2026-09-11 - The SDK for building Kubernetes APIs using CRDs.
...
* [Controller-runtime](https://github.com/kubernetes-sigs/controller-runtime) ⭐ 2,953 | 🐛 69 | 🌐 Go | 📅 2026-09-08 - Repo for the controller-runtime subproject of kubebuilder (sig-apimachinery).
...
* [KubeOps](https://github.com/buehler/dotnet-operator-sdk) ⭐ 371 | 🐛 5 | 🌐 C# | 📅 2026-09-11 - KubeOps is a kubernetes operator sdk in dotnet. Strongly inspired by kubebuilder.
* [Operatorkit](https://github.com/giantswarm/operatorkit) ⭐ 198 | 🐛 3 | 🌐 Go | 📅 2026-09-11 - An opinionated Go framework for developing Kubernetes operators.
...
* [Kube Foundry](https://github.com/kube-foundry/kube-foundry) ⭐ 19 | 🐛 3 | 🌐 Go | 📅 2026-04-01 - Kubernetes operator that runs AI coding agents (Claude Code, Codex, Cursor, Gemini, OpenCode) in sandboxed pods.
...
* [KubeStellar](https://github.com/kubestellar/kubestellar) ⭐ 711 | 🐛 213 | 🌐 Go | 📅 2026-09-03 - Multi-cluster configuration management for edge, multi-cloud, and hybrid scenarios using Kubernetes.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-12 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations.

## Dashboards & UIs

* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 148 | 🌐 TypeScript | 📅 2026-09-12 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations across edge and cloud clusters.
