...
* [Kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,303 | 🐛 71 | 🌐 Go | 📅 2026-09-02 - The SDK for building Kubernetes APIs using CRDs.
* [Operator SDK](https://github.com/operator-framework/operator-sdk) ⭐ 7,679 | 🐛 69 | 🌐 Go | 📅 2026-09-02 - Advanced Go SDK for building Kubernetes Operators.
* [Controller-runtime](https://github.com/kubernetes-sigs/controller-runtime) ⭐ 2,953 | 🐛 68 | 🌐 Go | 📅 2026-09-02 - Repo for the controller-runtime subproject of kubebuilder (sig-apimachinery).
...
* [Operatorkit](https://github.com/giantswarm/operatorkit) ⭐ 198 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - An opinionated Go framework for developing Kubernetes operators.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-03 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations.

## Dashboards & UIs

* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-03 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations across edge and cloud clusters.
